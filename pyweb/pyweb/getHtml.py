...
class GetHtml():
    ...
    def get_head(self, title):
        return '<!DOCTYPE html><html><head><meta charset="utf-8"><script src="http://code.jquery.com/jquery-latest.js"></script><title>' + title + '</title></head><body style="height: 900px;width: 900px;">'

    # 获取填了脚本后的body
    def get_end_body(self):
        return '</script><script type="text/javascript">/* 鼠标点击特效 */var a_idx = 0;jQuery(document).ready(function($) {$("body").click(function(e) {var a = new Array("仙女最可爱了", "仙女最漂亮了", "仙女最善良了", "你怎么那么迷人呀", "你好骚啊", "你怎么穿着我的衣服" ,"小可爱");var $i = $("<span></span>").text(a[a_idx]);a_idx = (a_idx + 1) % a.length;var x = e.pageX,y = e.pageY;$i.css({"z-index": 99999999,"top": y - 20,"left": x,"position": "absolute","font-weight": "bold","color": "#FF0000"});$("body").append($i);$i.animate({"top": y - 180,"opacity": 0},1500,function() {$i.remove();});});});</script></body></html>'

    # 获取网站主页
    def getDogFood(self):
        # 先写入开头
        # ret = '<!DOCTYPE html><html><head><meta charset="utf-8"><title>来自仙女和仙男的仙粮</title></head><body>'
        ret = self.get_head("来自仙女和仙男的仙粮")
